...
export function WalletPanel({
  ...
  return (
    <div className="relative">
      ...
      >
        <div
          className={`w-2 h-2 rounded-full animate-pulse ${isWrongNetwork ? 'bg-red-500' : 'bg-neon-green'}`}
        />
          ...
          <>
            ...
            >
              ...
              <div className="p-4 border-b border-white/5">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {wallet.network}{' '}
                      {isWrongNetwork && '(EXPECTED ' + EXPECTED_WALLET_NETWORK + ')'}
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="py-2 px-3 rounded-lg bg-white/5">
                    <p className="font-display text-white/30" style={{ fontSize: '9px' }}>
                      USDC BALANCE
                    </p>
                    <p className="font-display text-lg text-neon-amber mt-0.5">
                      {wallet.usdcBalance}
                    </p>
                    <p className="font-display text-white/25 mt-0.5" style={{ fontSize: '9px' }}>
                      ~
                      {Math.floor(
                        parseFloat(wallet.usdcBalance) / parseFloat(AMOUNT_USDC)
                      ).toLocaleString()}{' '}
                      queries
                    </p>
                  </div>
                  <div className="py-2 px-3 rounded-lg bg-white/5">
                    ...
                    <p className="font-display text-lg text-neon-cyan mt-0.5">
                      {wallet.xlmBalance}
                    </p>
                    <p className="font-display text-white/25 mt-0.5" style={{ fontSize: '9px' }}>
                      for gas fees
              ...
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                  <span
                    className="font-display text-white/30 tracking-widest"
                    style={{ fontSize: '10px' }}
                  >
                    RECENT TRANSACTIONS
                  </span>
