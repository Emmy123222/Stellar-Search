...
describe('constants — Express, Vercel, browser, MCP alignment', () => {
  ...
  it('FACILITATOR_URL matches expected default or configured value', () => {
    expect(FACILITATOR_URL_DEFAULT).toBe('https://www.x402.org/facilitator')
    expect(FACILITATOR_URL).toBeDefined()
  })
